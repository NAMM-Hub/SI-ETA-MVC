...
switch ($rol) {
	...
	<div class="card">
        ...
        ?>
			...
			<thead>
			<tr>
				<th colspan="2" class="th_sinAjuste"><div class="card_table">Total de profesores:</div></th>
				<?php
			...
			<tr>
				<th colspan="4" class="th_sinAjuste"><div class="card_table">Masculino</div></th>
				<th colspan="4" class="th_sinAjuste"><div class="card_table">Femenino</div></th>
			</tr>
			<tr>
	<?php
	...
	echo "<th colspan='4' class='th_sinAjuste'><div class='card_table'>Sin datos para femenino</div></th>";
				...
				<th class="th_sinAjuste">
					<div class="card_table">Información personal</div>
				</th>				
				<th class="th_sinAjuste">
			 			...
			 			<tr>
			 				...
			 				<td align="center" class="th_sinAjuste">
			 					<div class="card_table">
			 						<?php echo htmlspecialchars($apellido1); ?>
			 					</div>
			 				</td>
			 				<td align="center" class="th_sinAjuste">
			 				...
			 				<td align="center">
			 					<div class="card_table"><a href="<?php echo BASE_URL;?>admin/obtener_profesor/<?php echo $persona_id?>" class="bInfo">Ver información</a></div>
			 				</td>
			 				<td aling="center">
			 					<div class="card_table"><a href="<?php echo BASE_URL;?>/admin/delete/profesor/<?php echo htmlspecialchars($persona_id)?>" data-toggle="modal" data-target="#confirm-delete">Eliminar</a></div>
			 				</td>
						<?php 
							$contador++;
							}
