...
?></header>
	...
	<main class="mainListEstud">
		...
		<div class="card">
			<a href="<?php BASE_URL;?>download_listaEstudiante" title="Descargar lista"><span class="fa fa-floppy-o">Descargar lista</span></a>
		</div>
        ...
        ?>
			...
			<thead>
			<tr>
				<th colspan="4" class="th_sinAjuste"><div class="card_table">Total de estudiantes</div></th>

				<?php				
			if ($data['total_general'] > 0) {
				echo "<th class='th_sinAjuste' colspan='6'><div class='card_table'>".htmlspecialchars($data['total_general'])."</div></th>";
			}else{
				echo "<th class='th_sinAjuste' colspan='6'><div class='card_table'>Sin datos</div></th>";
			}
			...
			<tr>
				<th colspan="5" class="th_sinAjuste"><div class="card_table">Masculino</div></th>
				<th class="th_sinAjuste" colspan="5"><div class="card_table">Femenino</div></th>
			</tr>
			<tr>	
		<?php
		...
		?>
			...
			<tr>
				...
				<th class="th_sinAjuste">			
					<div class="card_table">Año/<br>Grado</div>
				</th>
				<th class="th_sinAjuste">			
					<div class="card_table">Estatus</div>
				</th>
				<th class="th_sinAjuste">			
					<div class="card_table">Periodo<br>escolar</div>
				</th>
				<th class="th_sinAjuste">			
					<div class="card_table">Información<br>del estudiante</div>
				</th>
				<th class="th_sinAjuste">
    	...
    	?>
			<tr>
				<td class="th_sinAjuste">
			 	...
			 	<td>
			 		<div class="card_table"><?php echo htmlspecialchars($ano_grado). 'º'; ?></div>
			 	</td>
			 	<td  class="th_sinAjuste">
			 		<div class="card_table"><?php echo htmlspecialchars($estatus); ?></div>
			 	</td>
			 	<td  class="th_sinAjuste">
			 		<div class="card_table"><?php if(!empty($ano_periodo1) and !empty($ano_periodo2)){
			 	...
			 	<td  class="th_sinAjuste">
			 		<div class="card_table"><a href="<?php echo BASE_URL;?>admin/obtener_estudiante/<?php echo htmlspecialchars($id_persona);?>" class="bInfo">Ver información</a></div>
			 	</td>
			 	<td>
			 		<div class="card_table"><a href="<?php echo BASE_URL;?>admin/delete/estudiante/<?php echo htmlspecialchars($id_persona)?>" data-toggle="modal" data-target="#confirm-delete" name="Eliminar">Eliminar</a></div>
			 	</td>
				<?php
					$contador++;
				}
