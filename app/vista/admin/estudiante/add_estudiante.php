...
<?php if (!empty($message)) : ?>
    <center><p class="message"><?= $message ?></p></center>

    <?php endif; ?>

    <main class="main_addPersona">
        <div class="card">
            <h3 class="h3_tituloAddStud">Registrar estudiante</h3>
        </div>
...
<div class="container_tablaAddPersona" id="container_mainAddPersona">
    ...
    <form id="myForm" action="<?php echo BASE_URL; ?>admin/insertarEstudiante" method="post">
        ...
        <div class="card">
            <table class="table_persona">
                  <tr>
                    ...
                    <tr>
                <td><input type="text" name="nombre1" pattern="[A-Za-z]{1,15}" required placeholder="Primer Nombre" value="<?php echo $data['nombre1'] ?? '';?>"></td>
                <td><input type="text" name="apellido1" patter="[A-Za-z]{1,15}" required placeholder="Primer Apellido" value="<?php echo $data['apellido1'] ?? '';?>"></td>
                    </tr>
                    ...
                    <tr>
                <td><input type="text" name="nombre2" pattern="[A-Za-z]{1,15}" placeholder="Segundo Nombre" value="<?php echo $data['nombre2'] ?? '';?>"></td>
                <td><input type="text" name="apellido2" patter="[A-Za-z]{1,15}" placeholder="Segundo Apellido" value="<?php echo $data['apellido2'] ?? '';?>"></td>
                    </tr>
                ...
                <option value="M" <?= (($data['sexo'] ?? '') == 'Masculino' ? 'selected' : '')?>>Masculino</option>';
                <option value="F" <?= (($data['sexo'] ?? '') == 'Femenino' ? 'selected' : '')?>>Femenino</option>';
                </select>
                </th>
                </tr>
                ...
                <td><input type="date" name="fechaNa" title="Ingresar fecha de nacimiento ej: 10/02/2012" placeholder="10/02/2012" value="<?php echo $data['fechaNa'] ?? '';?>"></td>
                </tr>
            ...
            <div class="correoEAndCedulaI">
                ...
                <td><input type="text" name="cedula" pattern="[0-9]{1,8}" required placeholder="Cédula de identidad o Cédula escolar" value="<?php echo $data['cedula'] ?? '';?>"></td>
            </div>
                ...
                <tr>
                    <th>
                        <div id="contenedor_municipio_texto" style="display:none;">
                            ...
                            <input type="text" name="municipio_texto" id="municipio_texto" maxlength="100">
                        </div>
                    </th>
                </tr>
                ...
                <tr>
                    <th>
                        <div id="contenedor_comunidad_texto" style="display:none;">
                            ...
                            <input type="text" name="ciudad_texto" id="ciudad_texto" maxlength="100">
                        </div>
                    </th>
                </tr>
                		...
                		<div class="estadCivil">
                    		<label for="estado_civil">Estado civil (*)</label>    
                				<select name="estadCivil" id="estado_civil" require>
                                    ...
                                    <option value="Viudo" <?= (($data['estadCivil'] ?? '') == "Viudo" ? 'selected' : '')?>>Divorciado(a)</option>';
                				</select>               
                		</div>
					</th>
                </tr>
