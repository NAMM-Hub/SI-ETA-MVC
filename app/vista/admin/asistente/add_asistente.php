...
<div class="container_mainAddPersona">
    ...
    <main class="main_addPersona">
        <div class="card">
            <h3 class="h3_tituloAddStud">Registrar asistente</h3>
        </div>
...
<div class="container_tablaAddPersona" id="container_mainAddPersona">
    ...
    <form action="<?php echo BASE_URL; ?>admin/insertarAsistente" method="post">
        ...
        <div class="card">
            <table class="table_persona">
                ...
                <div class="correoEAndCedulaI">
                    <th><p align="left">Cédula de identidad (*)</p></th>
                        ...
                        <select name="estado_id" id="estado" required>
                            ...
                            <?php
                                ...
                                if(is_array($dataEstados)){
                                    foreach($dataEstados as $estados){
                                        $id_estado = $estados['id_estados'];
                                        $nombre_estados = $estados['nombre_estado'];
                                        echo '<option value="'.$id_estado.'">'.$nombre_estados.'</option>';
                                    }
                                }
