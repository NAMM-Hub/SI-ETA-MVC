			 	...
			 	foreach($data['lista_materias'] as $lista) {
			 			...
			 			<tr>
							...
							<td align="center" class="th_sinAjuste">
			 				...
			 				<td align="center">
			 					<div class="card_table"><?php echo htmlspecialchars($ano_grado);?></div>
			 				</td>
			 				<td align="center">
			 					<div class="card_table"><?php echo htmlspecialchars($cantidad_profesor);?></a></div>
			 				</td>
			 				<td align="center" class="th_sinAjuste">
			 					<div class="card_table"><a href="<?php echo BASE_URL?>asistente/list_allocationProfesorMaterias/<?php echo htmlspecialchars($id_materias);?>">Ver profesores</a></div>
			 				</td>
			 			</tr>
			 		<?php 
			 			$contador++;
