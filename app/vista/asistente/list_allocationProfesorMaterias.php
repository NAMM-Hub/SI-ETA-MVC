...
<main class="main_ListMateria">
		...
		?>
			<tr>
				<th class="th_sinAjuste"><div class="card">NRO</div></th>
				<th class="th_sinAjuste"><div class="card">Nombre</div></th>
				<th class="th_sinAjuste"><div class="card">Apellido</div></th>
				<th class="th_sinAjuste"><div class="card">Cédula</div></th>			</tr>
			</thead>
			<tbody>			 		
			 	<tr><?php
