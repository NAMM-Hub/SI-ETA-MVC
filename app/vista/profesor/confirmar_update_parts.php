...
<header><?php
        ...
        <form id="myForm" action="<?php echo BASE_URL . 'profesor/' . $data['next_action'] . '/' .$data['ocupacion']. '/' .$data['seccion']. '/' . $data['id_persona']; ?>" method="post">
        ...
        <form action="<?php echo BASE_URL; ?>profesor/cancelar" method="post">
